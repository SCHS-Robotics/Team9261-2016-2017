...
public class BlueAutonomousRunWithEncoders extends BaseAutoRunWithEncoders {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        driveForward(18, 0.9);// forwards 18 inches, at 0.5 of max power initially
        sleep(500);
        turnBackward(160, 0, 0.9, 0); //left wheel backwards pivot 160 degrees, at an initial speed of 0.5
        sleep(500);
        ...
        motor2.setPower(0);
        sleep(500);
        turnForward(0, 40, 0, 0.9); //right wheel forwards pivot 40 degrees at a speed of 0.5
        sleep(500);
        leftLinePowerFWD = 0.2;
        RightLinePowerFWD = 0.2;
        while(!seesLineFWD() && opModeIsActive());// runs until both line sensors are detecting a line
        sleep(500);
        pushBeaconBlue(); //senses color and hits the according beacon
        sleep(500);
        driveBackward(15, 0.9); //backwards 15 inches, at a speed of 0.5
        sleep(500);
        leftLinePowerBCK = -0.2;
        RightLinePowerBCK = -0.2;
        while (!seesLineBCK() && opModeIsActive()); // runs until both line sensors are detecting a line
        sleep(500);
        pushBeaconBlue(); // senses color and hits the according beacon
        sleep(500);
        driveBackward(15, 0.9); // backwards 15 inches at an initial speed of 0.5
        sleep(500);
        turnForward(42, 0, 0.9, 0); // left wheel forwards pivot 42 degrees at an initial speed of 0.5
        sleep(500);
