...
public abstract class BaseAuto extends InitCode {
    ...
    public final int M2T1 = degreesToPositions(41);
    public final double PWRT1 = 0.5;

    //2nd turn
    public final int M1T2 = 0;
    public final int M2T2 = degreesToPositions(-37);
    public final double PWRT2 = -0.5;

    //2.5th turn
    public final int M1T25 = 0;
    public final int M2T25 = degreesToPositions(10);
    public final double PWRT25 = 0.5;


    //3rd turn
    public final int M1T3 = 0;
    public final int M2T3 = degreesToPositions(-90);
    public final double PWRT3 = -.5;

    //4th turn
    public final int M1T4 = degreesToPositions(45);
    ...
    public double LPWR = -0.08;
    public double LPWR2 = 0.08;
    ...
    //4th move
    public final int PM4 = inchesToPositions(27);
    public final double PWRM4 = 0.5;

    //5th move
    public final int PM5 = inchesToPositions(15);
    public final double PWRM5 = 0.7;

    //6th move
    public final int PM6 = inchesToPositions(80);
